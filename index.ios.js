...
/***/ function(module, exports, __webpack_require__) {
	...
	var ReactNativeBabel = _reactNative2['default'].createClass({
	  displayName: 'ReactNativeBabel',
	...
	AppRegistry.registerComponent('NativeStarter', function () {
	  return ReactNativeBabel;
	});
...
/***/ function(module, exports, __webpack_require__) {
	...
	var ReactNative = Object.assign(Object.create(__webpack_require__(3)), {
	  ...
	  Modal: __webpack_require__(9),
	  Navigator: __webpack_require__(10),
	  NavigatorIOS: __webpack_require__(11),
	  PickerIOS: __webpack_require__(12),
	  ProgressViewIOS: __webpack_require__(13),
	  ScrollView: __webpack_require__(14),
	  SegmentedControlIOS: __webpack_require__(15),
	  SliderIOS: __webpack_require__(16),
	  SwitchIOS: __webpack_require__(17),
	  TabBarIOS: __webpack_require__(18),
	  Text: __webpack_require__(19),
	  TextInput: __webpack_require__(20),
	  TouchableHighlight: __webpack_require__(21),
	  TouchableOpacity: __webpack_require__(22),
	  TouchableWithoutFeedback: __webpack_require__(23),
	  View: __webpack_require__(24),
	  WebView: __webpack_require__(25),

	  // APIs
	  ActionSheetIOS: __webpack_require__(26),
	  AdSupportIOS: __webpack_require__(27),
	  AlertIOS: __webpack_require__(28),
	  Animated: __webpack_require__(29),
	  AppRegistry: __webpack_require__(30),
	  AppStateIOS: __webpack_require__(31),
	  AsyncStorage: __webpack_require__(32),
	  CameraRoll: __webpack_require__(33),
	  Dimensions: __webpack_require__(34),
	  Easing: __webpack_require__(35),
	  ImagePickerIOS: __webpack_require__(36),
	  InteractionManager: __webpack_require__(37),
	  LayoutAnimation: __webpack_require__(38),
	  LinkingIOS: __webpack_require__(39),
	  NetInfo: __webpack_require__(40),
	  PanResponder: __webpack_require__(41),
	  PixelRatio: __webpack_require__(42),
	  PushNotificationIOS: __webpack_require__(43),
	  Settings: __webpack_require__(44),
	  StatusBarIOS: __webpack_require__(45),
	  StyleSheet: __webpack_require__(46),
	  VibrationIOS: __webpack_require__(47),

	  // Plugins
	  DeviceEventEmitter: __webpack_require__(48),
	  NativeAppEventEmitter: __webpack_require__(49),
	  NativeModules: __webpack_require__(50),
	  Platform: __webpack_require__(51),
	  requireNativeComponent: __webpack_require__(52),

	  // Prop Types
	  EdgeInsetsPropType: __webpack_require__(53),
	  PointPropType: __webpack_require__(54),

	  addons: {
	    LinkedStateMixin: __webpack_require__(55),
	    Perf: undefined,
	    PureRenderMixin: __webpack_require__(56),
	    TestModule: __webpack_require__(50).TestModule,
	    TestUtils: undefined,
	    batchedUpdates: __webpack_require__(57).batchedUpdates,
	    cloneWithProps: __webpack_require__(58),
	    createFragment: __webpack_require__(59).create,
	    update: __webpack_require__(60),
	  },
	});

	if (__DEV__) {
	  ReactNative.addons.Perf = __webpack_require__(61);
	  ReactNative.addons.TestUtils = __webpack_require__(62);
	}
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _reactNativeCamera = __webpack_require__(64);

	var _reactNativeCamera2 = _interopRequireDefault(_reactNativeCamera);

	var Info = __webpack_require__(65);

	var ActivityIndicatorIOS = _reactNative2['default'].ActivityIndicatorIOS;
	var Modal = _reactNative2['default'].Modal;
	...
	var TouchableHighlight = _reactNative2['default'].TouchableHighlight;
	var View = _reactNative2['default'].View;

	var Main = _reactNative2['default'].createClass({
	  displayName: 'Main',
	  ...
	  _onBarCodeRead: function _onBarCodeRead(res) {
	    var _this = this;
	    ...
	    fetch('http://www.walmart.com/product/mobile/api/upc/' + res.data).then(function (response) {
	  ...
	  _onOpenModal: function _onOpenModal() {
	    this.setState({
	      modalVisible: true
	    });
	  },
	  render: function render() {
	    return this.state.scanning ? _reactNative2['default'].createElement(
	      View,
	      { style: styles.wrapper },
	      _reactNative2['default'].createElement(
	        View,
	        { style: styles.centering },
	        _reactNative2['default'].createElement(ActivityIndicatorIOS, {
	      ...
	      _reactNative2['default'].createElement(
	        ...
	        _reactNative2['default'].createElement(
	          ...
	          _reactNative2['default'].createElement(View, { style: [styles.overlay] }),
	          _reactNative2['default'].createElement(
	            View,
	            { style: styles.cancel },
	            _reactNative2['default'].createElement(
...
/***/ function(module, exports, __webpack_require__) {
	...
	var ProductInfo = _reactNative2['default'].createClass({
	  displayName: 'ProductInfo',

	  render: function render() {
	    console.log(this.props.product);
	    if (this.props.product) {
	      var markup = _reactNative2['default'].createElement(
	        ScrollView,
	        { contentContainerStyle: styles.wrapper },
	        _reactNative2['default'].createElement(Image, { source: { uri: _lodash2['default'].get(this.props.product, 'product.primaryImageUrl', '') }, style: styles.img }),
	        _reactNative2['default'].createElement(
	          Text,
	          { style: styles.title },
	          this.props.product.product.productName
	        )
	      );
	    } else {
	      var markup = _reactNative2['default'].createElement(
